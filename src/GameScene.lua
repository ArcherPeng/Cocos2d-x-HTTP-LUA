...
function GameScene:ctor()
    ...
    APUtils.EventDispatcher:destoryInstance()
end
...
function GameScene:createLayerFarm()
    ...
    --         {type = "int", value = 100 },
    --         {
    --             {type = "str", value = "ArcherPeng Lua测试" },
    --         },
    --         {type = "long", value = 3000 },
    --     },
    --     {type = "bool", value = false },
    -- }
    APUtils.EventDispatcher:getInstance():add("1_2",GameScene.httpMsgCallback,self) -- 先设置监听
    local sendData = 
    {
        {type = "byte", value = 1 },
        {type = "byte", value = 1 },
    ...
    APUtils.httpSend("http://192.168.1.123:8080/xteu_wjzz/main.do",sendData)
...
function GameScene:httpMsgCallback(eventKey,msg)
    cclog("int :" .. msg:readInt())
    cclog("str :" .. msg:readString())
    cclog("long :" .. msg:readLong())
